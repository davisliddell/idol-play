...
export default function PlayerCard({
  ...
  const cardColor = tribeColor(tribe).card

  if (compact) {
    return (
      <div className={`relative rounded-lg p-2 border-2 ${cardColor} ${isEliminated ? 'opacity-40 grayscale' : ''}`}>
  ...
  return (
    <div className={`relative rounded-lg p-4 border-2 ${cardColor} ${isEliminated ? 'opacity-40 grayscale' : ''} transition-all duration-300`}>
